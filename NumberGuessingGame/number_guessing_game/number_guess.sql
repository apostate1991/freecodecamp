...
SELECT pg_catalog.setval('public.users_username_id_seq', 22, true);
...
--
-- Name: games fk_username_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_username_id FOREIGN KEY (username_id) REFERENCES public.users(username_id);


--
-- Name: stats fk_username_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
